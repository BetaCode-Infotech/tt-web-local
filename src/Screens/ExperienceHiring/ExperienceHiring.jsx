...
function ExperienceHiring() {
  ...
  const [active, setActive] = React.useState("employer");
            ...
            <div className="card-wrapper">
              <div className="card-item">
                ...
                <p className="card-caption-text">
                  ...
                  seekers an easy and cost-effective process for companies of
                  all sizes.
                </p>
              </div>
              <div className="card-item">
                ...
                <p className="card-caption-text">
                  ...
                  position in the near future or hundreds ofpositions across an
        ...
        <div className="second-container">
          <div className="card-grid">
            <div className="grid-card">
              <p  className="grid-card-text">Al+ HI (Human intelligence)</p>
            ...
            <div className="grid-card tall">
              ...
              <p className="grid-card-text-head">Skill match (Beyond the Keywords)</p>
              <p className="grid-card-text">
            ...
            <div className="grid-card">
              ...
              <p className="grid-card-text-head">Free Job posting and Employer Branding</p>
              <p className="grid-card-text">
                At TrueTalent, employing companies have the unrestricted ability
                to post as many job openings as they desire at no additional
                cost, as we are not only a candidate search platform but also an
                employer branding platform that assists businesses in increasing
                their Employer Brand Value.
              </p>
            </div>
            <div className="grid-card">
              <p className="grid-card-text">USER ACCESS</p>
              <p className="grid-card-text-head">Free multi-user access</p>
              <p className="grid-card-text">
                We believe what you receive should be shared with everyone on
                your tearn at no additional cost, so there are no fees for
                additional logins, In fact, we do not charge for any login, not
                even the first one.
              </p>
            </div>
            <div className="grid-card tall">
              ...
              <p className="grid-card-text">
                What should least burden hiring companies is the sourcing cost,
                as it is only one of the many costs associated with hiring
                employees. Hence all our plans are pay-as-you-go. Hence all our
                plans are pay-as-you-go. You spend only what you need and avoid
                all bulk and high onetime purchases when you use TrueTalent
              </p>
            </div>
            <div className="grid-card">
              ...
              <p className="grid-card-text">
                TrueTalent is the only job platform that provides employers with
                the options to hire both full time employees as well as gig
                (freelance) workers. And all these through a single sign-on. So
                whether you are looking for hiring a full time employee or
                looking to hire for a short assignment, you need to look no
                further than TrueTalent.
              </p>
            </div>
          </div>
        </div>
