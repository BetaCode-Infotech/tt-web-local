      ...
      <div className="experience-hiring-container">
        <div className="first-container">
          ...
          {active === "employer" ? (
              ...
              <div className="features-container">
                <div className="card-wrapper">
                  ...
                  <div className="card-item">
                    ...
                    <p className="card-caption-text">
                      {" "}
                      TrueTalent has a suitable option and pricing plan for you,
                      regardless of whether you are seeking to fill a single
                      position in the near future or hundreds ofpositions across
                      an array of skills and industries.
                    </p>
                  </div>
                  <div className="card-item">
                    <div className="feature-card">
                    ...
                    <p className="card-caption-text">
                      {" "}
                      With a Pay-as-you-go pricing model, TrueTalent's costs are
                      always proportional to your requirements.{" "}
                    </p>
                  </div>
                </div>
              </div>
              <div className="second-container">
                <div className="card-grid">
                  <div className="grid-card">
                    ...
                    <p className="grid-card-text-head">Al driven JD Creation</p>
                    <p className="grid-card-text">
                      TrueTalent assists you in generating a well-articulated
                      and thorough JD for each job opening you have, using only
                      the skills and years of experience you have at their
                      disposal. A detailed JD is always advantageous for
                  ...
                  <div className="grid-card">
                    ...
                    <p className="grid-card-text">
                      We believe what you receive should be shared with everyone
                      on your tearn at no additional cost, so there are no fees
                      for additional logins, In fact, we do not charge for any
                      login, not even the first one.
                    </p>
                  </div>
                  ...
                  <div className="grid-card">
                    ...
                    <p className="grid-card-text">
                      While most talent search platforms provide search options
                      based on keywords, which leads to a large number of
                      irrelevant and low-matching profiles and ultimately makes
                      it more difficult for recruiters to obtain relevant
                      profiles, TrueTalent uses a customized and advanced
                      technology algorithm to identify candidates whose skills
                      precisely match the search skills. Multiple parameters are
                      taken into account by the customized algorithm in order to
                  ...
                  <div className="grid-card">
                    ...
                    <p className="grid-card-text">
                      What should least burden hiring companies is the sourcing
                      cost, as it is only one of the many costs associated with
                      hiring employees. Hence all our plans are pay-as-you-go.
                      Hence all our plans are pay-as-you-go. You spend only what
                      you need and avoid all bulk and high onetime purchases
                      when you use TrueTalent
                    </p>
                  </div>
                  ...
                  <div className="grid-card">
                    ...
                    <p className="grid-card-text">
                      ...
                      ability to post as many job openings as they desire at no
                      additional cost, as we are not only a candidate search
                      platform but also an employer branding platform that
                      assists businesses in increasing their Employer Brand
                      Value.
                    </p>
                  </div>
                  ...
                  <div className="grid-card">
                    ...
                    <p className="grid-card-text-head">Full Time / Gig work</p>
                    <p className="grid-card-text">
                      ...
                      these through a single sign-on. So whether you are looking
                      for hiring a full time employee or looking to hire for a
                      short assignment, you need to look no further than
                      TrueTalent.
                    </p>
                  </div>
                </div>
            ...
            <>
              <h1 className="love-text">Why Jobseekers Prefer our Platform?</h1>
              <div className="features-container">
                <div className="card-wrapper">
                  <div className="card-item">
                    <div className="feature-card">
                ...
                <div className="card-grid">
                  <div className="grid-card">
                    ...
                    <p className="grid-card-text">
                      ...
                      providing a unique online presence and profile. Recruiters
                      can access your in-depth profile and offer opportunities
                      that match your skills and aptitude.
                    </p>
                  </div>
                  <div className="grid-card">
                    ...
                    <p className="grid-card-text">
                      ...
                      receiving job alerts and notifications right to your email
                      or phone. Never miss out on great job opportunities again.
                    </p>
                  </div>
                  <div className="grid-card">
                  ...
                  <div className="grid-card">
                    ...
                    <p className="grid-card-text">
                      Our powerful tools give you everything you need to prepare
                      for job interviews, including personalized feedback and Al
                      powered tips to help you imprave your resume and cover
                      letter. We also offer career counseling services to help
                      you take your next steps towards success.
                    </p>
                  </div>
                  ...
                  <div className="grid-card">
                    ...
                    <p className="grid-card-text">
                      TrueTalent makes it easy for you to directly connect with
                      recruiters one-on-one, cutting down on time and hassle of
